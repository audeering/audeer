...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ['t3.ogg', 't2.wav', 't1.wav', 'sub/t1.wav', 'sub/sub/t1.ogg'],
            '.',
            '',
            ['t1.wav', 't2.wav', 't3.ogg'],
            False,
        ...
        (
            ...
            '.',
            '',
            ['sub/sub/t1.ogg', 'sub/t1.wav', 't1.wav', 't2.wav', 't3.ogg'],
            True,
        ),
        (
            ['t1.wav', 't2.wav', 't3.ogg', 'sub/t1.wav', 'sub/sub/t1.ogg'],
            '.',
            'ogg',
            ['t3.ogg'],
            False,
        ...
        (
            ...
            '.',
            'ogg',
            ['sub/sub/t1.ogg', 't3.ogg'],
            True,
        ),
        (['t1.wav', 'sub/t1.wav'], 't1.wav', '', ['t1.wav'], False),
        (['t1.wav', 'sub/t1.wav'], 't1.wav', '', ['t1.wav'], True),
    ],
)
